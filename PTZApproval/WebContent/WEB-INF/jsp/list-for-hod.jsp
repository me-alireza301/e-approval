...
<div id="content">
<display:table name="processList" requestURI="/list-for-hod.do" 
      				id="submitForm" uid="submitForm"  excludedParams="*"    
      				class="displaytag" cellpadding="0" style="width:800px" pagesize="20">
           		<display:column title="User ID">
           		<a href="show-approve-request.do?processId=${submitForm.processId}"/>${submitForm.userId}</a>
           		</display:column>
